    ...
    public override void Load()
    {
        ...
        try
        {
            roleColors = new Dictionary<CustomRoles, string>()
            {
                ...
                {CustomRoles.Illusion, "#E500F8"},
                {CustomRoles.Dictator, "#df9b00"},
                {CustomRoles.Captain, "#d72bF0" },
                ...
                {CustomRoles.Spy, "#9CCDFF"},
                {CustomRoles.Colorist, "#8f0d56"},
        ...
        //        {CustomRoles.Sorcerer, "#663399"},
                ...
                {CustomRoles.ChokingHazard, "#FF8A18"},
