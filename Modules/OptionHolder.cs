...
//Task Management
   ...
   /* public static readonly string[] addonGuessModeCrew =
    ...
    public static void Load()
    {
        ...
        AddBracketsToAddons = BooleanOptionItem.Create(13500, "BracketAddons", false, TabGroup.Addons, true)
            .SetGameMode(CustomGameMode.Standard);
        ...
        SetupSingleRoleOptions(4950, TabGroup.ImpostorRoles, CustomRoles.Troll, 1, zeroOne: false);
...
//======================================================== * Neutral Roles * ==========================================================================\\
        ...
        // Hater (Whoever chose the name "FFF" and thought HMM yeah this seems like a good role name, please do not make roles again)
    ...
    /*    SetupAdtRoleOptions(19000, CustomRoles.Sidekick, canSetNum: true, tab: TabGroup.OtherRoles);
     ...
     //   JackalWinWithSidekick = BooleanOptionItem.Create(19015, "JackalWinWithSidekick", true, TabGroup.OtherRoles, false)
        ...
        TemporaryAntiBlackoutFix = BooleanOptionItem.Create(44427, "TemporaryAntiBlackoutFix", true, TabGroup.SystemSettings, false)
            .SetHeader(true)
            .SetColor(Color.red);
        GradientTagsOpt = BooleanOptionItem.Create(44430, "EnableGadientTags", true, TabGroup.SystemSettings, false)
           .SetHeader(true);
