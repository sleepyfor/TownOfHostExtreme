    ...
    public static CustomRoles GetVNRole(this CustomRoles role) // RoleBase: Impostor, Shapeshifter, Crewmate, Engineer, Scientist
    {
        return role.IsVanilla()
            ...
            : role switch
            {
                ...
                CustomRoles.Illusion => CustomRoles.Engineer,
    ...
    public static CustomRoles GetErasedRole(this CustomRoles role) // Erased RoleBase - Crewmate or Engineer or Scientist
    {
        return role.IsVanilla()
            ...
            : role switch
            {
                ...
                CustomRoles.Captain => CustomRoles.CrewmateTOHE,
                CustomRoles.Illusion => CustomRoles.EngineerTOHE,
 ...
 //           CustomRoles.PotionMaster or
    ...
    public static CustomWinner GetNeutralCustomWinnerFromRole(this CustomRoles role) // only to be used for Neutrals
        => role switch
        {
            ...
            CustomRoles.Ritualist => CustomWinner.Coven,
            ...
            CustomRoles.Poisoner => CustomWinner.Coven,
            CustomRoles.Necromancer => CustomWinner.Coven,
            CustomRoles.HexMaster => CustomWinner.Coven,
            CustomRoles.Occultist => CustomWinner.Occultist,
            CustomRoles.Succubus => CustomWinner.Succubus,
            CustomRoles.Wraith => CustomWinner.Coven,
            CustomRoles.Banshee => CustomWinner.Coven,
            CustomRoles.CovenLeader => CustomWinner.Coven,
            ...
            CustomRoles.Jinx => CustomWinner.Coven,
            CustomRoles.CursedSoul => CustomWinner.CursedSoul,
            CustomRoles.PotionMaster => CustomWinner.Coven,
            ...
            CustomRoles.Medusa => CustomWinner.Coven,
    ...
    public static CustomRoles GetNeutralCustomRoleFromCountType(this CountTypes type) //only to be used for NKs
        => type switch
        {
            ...
            CountTypes.Coven => CustomRoles.Jinx,
            ...
            CountTypes.Impostor => CustomRoles.Refugee,
